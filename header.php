...
<head>
    ...
    <link href="assets/simple-line-icons/css/simple-line-icons.min.css" rel="stylesheet">
...
<body>
                ...
                <div class="modal-body">
                    <div class="login-registration-form">
                        ...
                        <form method="post" action="">
                            ...
                            <button type="submut" class="login-btn mb-20 text-center">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <div class="modal login-modal" id="user-terms" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-clode-btn" data-bs-dismiss="modal"></div>
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="login-registration-form">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dicta porro quibusdam ipsum alias adipisci quia, minus, reiciendis aut quos cupiditate accusantium libero ad. Vitae dolore quo quidem perspiciatis. Labore, earum!
                        Voluptates velit amet praesentium recusandae animi error laboriosam, laborum tenetur odio aperiam illo ea cum nisi aliquam, eligendi accusamus at? In facilis expedita numquam cum molestiae placeat officia nihil repellat.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="top-bar style-2">
        <div class="topbar-left two">
            ...
            <div class="content">
                <span>Email:</span>
                <a href="mailto:">tours.paradise08@gmail.com</a>
            </div>
        </div>
        <p>50% Off Your Next Trip. Hurry Up For your new Tour! <a href="contact-us.php">Book Your Tour</a> </p>
        <div class="topbar-right">
            <div class="social-icon-area">
                <ul>
                    <li><a href="https://www.facebook.com/ParadiseToursNTravels"><i class="bx bxl-facebook"></i></a></li>
                    <li><a href="https://twitter.com/ParadiseToursN1"><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"
                                fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                                <path
                                    d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z" />
                            </svg></a></li>
                    <li><a href="https://www.linkedin.com/company/79773800/admin/"><i class="bx bxl-linkedin"></i></a></li>
                    <li><a href="https://www.instagram.com/tours.paradise/"><i class="bx bxl-instagram"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <header class="header-area style-1">
        <div class="header-logo d-lg-none d-flex">
            <a href="index.php">
                <img alt="image" class="img-fluid" src="assets/img/logo.png">
            </a>
        </div>
        ...
        <div class="main-menu">
            ...
            <ul class="menu-list">
                ...
                <li>
                    <a href="package.php" class="drop-down">Tours Packages</a><i class="bi bi-plus dropdown-icon"></i>
                    <!-- <ul class="sub-menu">
                ...
                <li>
                    <a href="cab-tariff.php">Cab Tariff</a><i class="bi bi-plus dropdown-icon"></i>
                </li>
                <!-- <li class="menu-item-has-children">
                    <a href="destination1.html" class="drop-down">Destination</a><i
                ...
                <li>
                    <a href="blogs.php" class="drop-down">Blogs</a>
                </li>
                <li>
                    <a href="reviews.php" class="drop-down">Reviews</a>
                </li>
                <li>
            ...
            <div class="hotline-area d-lg-none d-flex">
                ...
                <div class="content">
                    ...
                    <h6><a href="tel:9776902122">+919776902122</a></h6>
                </div>
            </div>
        </div>

                ...
                <div class="row g-lg-4 gy-5 justify-content-center">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-widget">
                            ...
                            <a href="#" class="primary-btn1">Book A Tour</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-md-start">
                        <div class="footer-widget">
                            <div class="single-contact mb-30">
                                ...
                                <a href="tel:97769 02122">+9197769 02122</a>
                            </div>
                            <div class="single-contact mb-35">
                                ...
                                <a href="mailto:tours.paradise08@gmail.com">tours.paradise08@gmail.com</a>
                            </div>
                            <div class="single-contact">
                                ...
                                <a
                                    href="https://maps.app.goo.gl/vAQN91LEU6FodbTdA">Idco Info Park, 308, 3rd Floor, DLF Cybercity,<br> Chandaka Industrial Estate, Bhubaneswar,<br> Odisha 751024</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div
                        ...
                        <ul class="social-list">
                            <li>
                                <a href="https://www.facebook.com/ParadiseToursNTravels"><i class="bx bxl-facebook"></i></a>
                            </li>
                            <li>
                                <a href="https://twitter.com/ParadiseToursN1"><svg xmlns="http://www.w3.org/2000/svg" width="10"
                            ...
                            <li>
                                <a href="https://www.linkedin.com/company/79773800/admin/"><i class="bx bxl-linkedin"></i></a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/tours.paradise/"><i class="bx bxl-instagram"></i></a>
                            </li>
                        </ul>
                        <p>©Copyright 2024 Paradise | Design By <a href="#">Techinnovator</a></p>
